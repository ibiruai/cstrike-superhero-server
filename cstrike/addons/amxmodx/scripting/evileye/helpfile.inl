...
public create_helpfile_html_ru(type)
{
	...
	fputs(thefile, "<p>Убивая противников и выполняя цели карты, вы получаете очки опыта. Чем выше уровень убитого вами игрока, тем больше опыта вы получаете. Набрав опыт и перейдя на следующий уровень, вы можете выбрать новую способность. Начальный уровень - нулевой, у игроков нет способностей на этом уровне.</p><p>Содержание:</p><ol><li><a href='#commands'>Команды чата</a></li><li><a href='#howtouse'>Как пользоваться способностями?</a></li><li><a href='#powers'>Список способностей</a></li><li><a href='#links'>Ссылки</a></li></ol><h2 id='commands'>Команды чата</h2><hr><p>Чтобы открыть главное меню, нажмите клавишу [ <strong>I</strong> ] или напишите в чат <strong>/shmenu</strong>. Многое из перечисленного ниже также доступно из главного меню, и вам нет необходимости запоминать эти команды.</p><table><tr><td>say /help</td><td>Эта справочная страница</td></tr><tr><td>say /showmenu</td><td>Меню выбора способностей</td></tr><tr><td>say /herolist</td><td><a href='#powers'>Список способностей</a> (вы также можете использовать команду ^"herolist^" в консоли)</td></tr><tr><td>say /myheroes</td><td>Список взятых вами способностей</td></tr><tr><td>say /clearpowers</td><td>Сбрасывает все ваши способности</td></tr><tr><td>say /drop &lt;hero&gt;</td><td>Сбрасывает одну вашу способность</td></tr><tr><td>say /whohas &lt;hero&gt;</td><td>Показывает вам, у кого есть указанная способность</td></tr><tr><td>say /playerskills [@ALL|@CT|@T|name]</td><td>Показывает вам, какие способности выбраны другими игроками</td></tr><tr><td>say /playerlevels [@ALL|@CT|@T|name]</td><td>Показывает вам, какого уровня другие игроки</td></tr><tr><td>say /automenu</td><td>Включить/выключить автоматическое появление меню выбора способностей</td></tr><tr><td>say /helpon</td><td>Отобразить справочное HUD сообщение</td></tr><tr><td>say /helpoff</td><td>Скрыть справочное HUD сообщение</td></tr></table><h2 id='howtouse'>Как пользоваться способностями?</h2><hr>")
	
	fputs(thefile, "<p><span class='passive_power'>Пассивные способности</span> используются автоматически. Чтобы использовать <span class='active_power'>активные способности</span>, вам нужно назначить клавишу на команду +power#, где # - номер активной способности. Для этого откройте консоль (~ или ё) и напишите в консоли: bind&nbsp;^"клавиша^"&nbsp;^"команда^". В нашем случае команда - ^"+power#^". Вот пара примеров:</p><ul><li>bind f +power1</li><li>bind mouse3 +power2</li></ul>")
