...
// 08 dec 2018 - Evileye - REGENERATION_ONLY 0/1 (0 = give all Wolverine's powers, 1 = give HP Regeneration only)
...
// 0 = give all Wolverine's powers, 1 = give HP Regeneration only [Default 0]
#define REGENERATION_ONLY 1
...
#else
	sh_set_hero_info(gHeroID, "Auto-Heal", "HP Regeneration")
#endif
