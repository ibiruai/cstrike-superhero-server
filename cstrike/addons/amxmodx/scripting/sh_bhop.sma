// Bunny Hop Abilities port
// https://forums.alliedmods.net/showthread.php?t=69840
...
#define PLUGIN	"SUPERHERO Bunny Hop" //"Bhop Abilities"
...
new g_iCdWaterJumpTime[SH_MAXSLOTS+1]
new bool:g_bAlive[SH_MAXSLOTS+1]
new bool:g_bAutoBhop[SH_MAXSLOTS+1]

new g_pcvarBhopStyle, g_pcvarAutoBhop, g_pcvarFallDamage
new g_pcvarGravity

new gHeroID
new const gHeroName[] = "Bunny Hop"
new bool:gHasAutoBhop[SH_MAXSLOTS+1]
...
public plugin_init()
{
	...
	new pcvarLevel = register_cvar("bhop_level", "12")

	// FIRE THE EVENTS TO CREATE THIS SUPERHERO!
	gHeroID = sh_create_hero(gHeroName, pcvarLevel)
	sh_set_hero_info(gHeroID, "Auto Bhop", "Get auto bunny hop")
...
public sh_hero_init(id, heroID, mode)
{
	...
	switch(mode) {
		case SH_HERO_ADD: {
			gHasAutoBhop[id] = true
			server_cmd("amx_autobhop #%i 1", get_user_userid(id))
		}
		case SH_HERO_DROP: {
			gHasAutoBhop[id] = false
			server_cmd("amx_autobhop #%i 0", get_user_userid(id))
		}
	}
